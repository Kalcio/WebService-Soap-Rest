...
namespace ClienteSOAP.WebServiceSOAP {
    ...
    public partial class Soap : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public Soap() {
            this.Url = global::ClienteSOAP.Properties.Settings.Default.ClienteSOAP_WebServiceSOAP_Soap;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapRpcMethodAttribute("http://localhost/SOAP-API/SOAP-API/index.php/validarRut", RequestNamespace="T1_Redes.alv", ResponseNamespace="T1_Redes.alv")]
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapRpcMethodAttribute("http://localhost/SOAP-API/SOAP-API/index.php/separarNombres", RequestNamespace="T1_Redes.alv", ResponseNamespace="T1_Redes.alv")]
        [return: System.Xml.Serialization.SoapElementAttribute("separa")]
        public nombresSeparados separarNombres(string name) {
            object[] results = this.Invoke("separarNombres", new object[] {
                        name});
            return ((nombresSeparados)(results[0]));
        }
